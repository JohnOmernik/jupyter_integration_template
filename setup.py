...
version_ns = {}
integration_str = "integration" # This could change to hive, drill, elastic etc.
...
setup_args = dict(
    ...
    long_description="A magic function for working with " + integration_str + " for Python3 based Jupyter Notebooks",
    author="John Omernik",
